...
<div id="content_wrapper">
	...
	<div id="right">
		...
		<p class="product_text">Кабели предназначены для передачи и распределения электрической энергии в стационарных установках на номинальное напряжение 0,66 или 1 кВ частоты 50 Гц. Для снабжения электроустановок, требующих уплотнения кабелей при вводе.</p>
		...
		<p class="construction_text"><strong>Заполнение</strong> – заполнитель из эластополимера.</p>
		<p class="construction_text"><strong>Оболочка</strong> – ПВХ  пластикат.</p>
		...
		<a class="download_doc" href="/files/AVVGz, VVGz.xls">Скачать техническую документацию по кабелю <strong>АВВГз, ВВГз</strong></a>
	</div>
</div>