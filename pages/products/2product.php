...
<div id="content_wrapper">
	...
	<div id="right">
		...
		<p class="construction_text"><strong>Изоляция</strong> – поливинилхлоридная композиция пониженной пожароопасности.</p>
		<p class="construction_text"><strong>Поясная изоляция</strong> – поливинилхлоридная композиция пониженной пожароопасности.</p>
		<p class="construction_text"><strong>Защитный покров</strong> – две стальные ленты и защитный шланг из поливинилхлоридной композиции пониженной пожароопасности.</p>
		...
		<a class="download_doc" href="/files/AVBbSHv-LS, VBbSHv-LS.xls">Скачать техническую документацию по кабелю <strong>АВБбШвнг-LS, ВБбШвнг-LS</strong></a>
	</div>
</div>